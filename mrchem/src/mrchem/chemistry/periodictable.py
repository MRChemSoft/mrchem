...
PeriodicTable = {
    ...
    Element([
        ...
        '14.4', 'Hydrogen', '110.0', '3.75', 'HEX', '1.731', '1s1'
    ]),
    'he':
    Element([
        '0.49', '0.93', '2', '4.002602', 'He', '4.215', '0.95', '0.1787',
        '0.0', 'Helium', '-26.0', '3.57', 'HEX', '1.633', '1s2'
    ]),
    'li':
    Element([
    ...
    Element([
        ...
        '17.3', 'Nitrogen', '-79.0', '4.039', 'HEX', '1.651', '1s2_2s2_2p3'
    ]),
    'o':
    Element([
    ...
    Element([
        ...
        '17.1', 'Fluorine', '0.0', '0.00', 'MCL', '0.00', '1s2_2s2_2p5'
    ]),
    'ne':
    Element([
        '0.51', '0.71', '10', '20.1797', 'Ne', '27.096', '24.553', '0.901',
        '16.7', 'Neon', '63.0', '4.43', 'FCC', '0.00', '1s2_2s2_2p6'
    ]),
    'na':
    Element([
        '2.23', '1.54', '11', '22.989768', 'Na', '1156', '371.0', '0.97',
        '23.7', 'Sodium', '150.0', '4.23', 'BCC', '0.00', '[Ne]3s1'
    ]),
    'mg':
    Element([
    ...
    Element([
        ...
        '10.0', 'Aluminum', '394.0', '4.05', 'FCC', '0.00', '[Ne]3s2_3p1'
    ]),
    'si':
    Element([
        '1.46', '1.11', '14', '28.0855', 'Si', '3540.0', '1685', '2.33',
        '12.1', 'Silicon', '625.0', '5.43', 'DIA', '0.00', '[Ne]3s2_3p2'
    ]),
    'p':
    Element([
        '1.23', '1.06', '15', '30.97362', 'P', '550.0', '317.30', '1.82',
        '17.0', 'Phosphorus', '0.0', '7.17', 'CUB', '0.00', '[Ne]3s2_3p3'
    ]),
    's':
    Element([
        '1.09', '1.02', '16', '32.066', 'S', '717.75', '388.36', '2.07',
        '15.5', 'Sulfur', '0.0', '10.47', 'ORC', '0.00', '[Ne]3s2_3p4'
    ]),
    'cl':
    Element([
        '0.97', '0.99', '17', '35.4527', 'Cl', '239.1', '172.16', '3.17',
        '22.7', 'Chlorine', '0.0', '6.24', 'ORC', '0.00', '[Ne]3s2_3p5'
    ]),
    'ar':
    Element([
        '0.88', '0.98', '18', '39.948', 'Ar', '87.30', '83.81', '1.784',
        '28.5', 'Argon', '85.0', '5.26', 'FCC', '0.00', '[Ne]3s2_3p6'
    ]),
    'k':
    Element([
        '2.77', '2.03', '19', '39.0983', 'K', '1032', '336.35', '0.86',
        '45.46', 'Potassium', '100.0', '5.23', 'BCC', '0.00', '[Ar]4s1'
    ]),
    'ca':
    Element([
    ...
    Element([
        ...
        '7.23', 'Chromium', '460.0', '2.88', 'BCC', '0.00', '[Ar]3d5_4s1'
    ]),
    'mn':
    Element([
    ...
    Element([
        ...
        '23.5', 'Bromine', '0.0', '6.67', 'ORC', '0.00', '[Ar]3d10_4s2_4p5'
    ]),
    'kr':
    Element([
        '1.03', '1.12', '36', '83.80', 'Kr', '119.80', '115.78', '3.74',
        '38.9', 'Krypton', '-73.0', '5.72', 'FCC', '0.00', '[Ar]3d10_4s2_4p6'
    ]),
    'rb':
    Element([
    ...
    Element([
        ...
        '10.87', 'Niobium', '275.0', '3.30', 'BCC', '0.00', '[Kr]4d4_5s1'
    ]),
    'mo':
    Element([
    ...
    Element([
        ...
        '8.3', 'Rhodium', '-350.0', '3.80', 'FCC', '0.00', '[Kr]4d8_5s1'
    ]),
    'pd':
    Element([
    ...
    Element([
        ...
        '13.1', 'Cadmium', '120.0', '2.98', 'HEX', '1.886', '[Kr]4d10_5s2'
    ]),
    'in':
    Element([
    ...
    Element([
        ...
        '16.3', 'Tin', '170.0', '5.82', 'TET', '0.546', '[Kr]4d10_5s2_5p2'
    ]),
    'sb':
    Element([
    ...
    Element([
        ...
        '25.74', 'Iodine', '0.0', '7.27', 'ORC', '0.00', '[Kr]4d10_5s2_5p5'
    ]),
    'xe':
    Element([
        '1.24', '1.31', '54', '131.29', 'Xe', '165.03', '161.36', '5.89',
        '37.3', 'Xenon', '-55.0', '6.20', 'FCC', '0.00', '[Kr]4d10_5s2_5p6'
    ]),
    'cs':
    Element([
        '3.34', '2.35', '55', '132.90543', 'Cs', '944', '301.55', '1.87',
        '71.07', 'Cesium', '-40.0', '6.05', 'BCC', '0.00', '[Xe]6s1'
    ]),
    'ba':
    Element([
    ...
    Element([
        ...
        '20.73', 'Lanthanum', '132.0', '3.75', 'HEX', '1.619', '[Xe]5d1_6s2'
    ]),
    'hf':
    Element([
    ...
    Element([
        ...
        '10.90', 'Tantalum', '225.0', '3.31', 'BCC', '0.00', '[Xe]4f14_5d3_6s2'
    ]),
    'w':
    Element([
    ...
    Element([
        ...
        '10.2', 'Gold', '170.0', '4.08', 'FCC', '0.00', '[Xe]4f14_5d10_6s1'
    ]),
    'hg':
    Element([
    ...
    Element([
        ...
        '22.54', 'Actinium', '0.0', '5.31', 'FCC', '0.00', '[Rn]6d1_7s2'
    ]),
    'rf':
    Element([
    ...
    Element([
        ...
        'Nielsbohrium', '0.0', '0.00', '', '0.00', '2ms'
    ]),
    'hs':
    Element([
    ...
    Element([
        ...
        '(recent_disc.)', '0.0', '0.00', '', '0.00', '280\265s'
    ]),
    'ce':
    Element([
    ...
    Element([
        ...
        '28.9', 'Europium', '-107.0', '4.61', 'BCC', '0.00', '[Xe]4f7_5d0_6s2'
    ]),
    'gd':
    Element([
    ...
    Element([
        ...
        '19.2', 'Terbium', '-188.0', '3.60', 'HEX', '1.581', '[Xe]4f9_5d0_6s2'
    ]),
    'dy':
    Element([
    ...
    Element([
        ...
        '18.7', 'Holmium', '-191.0', '3.58', 'HEX', '1.570', '[Xe]4f11_5d0_6s2'
    ]),
    'er':
    Element([
    ...
    Element([
        ...
        '18.1', 'Thulium', '-200.0', '3.54', 'HEX', '1.570', '[Xe]4f13_5d0_6s2'
    ]),
    'yb':
    Element([
    ...
    Element([
        ...
        '12.59', 'Uranium', '-210.0', '2.85', 'ORC', '0.00', '[Rn]5f3_6d1_7s2'
    ]),
    'np':
    Element([
