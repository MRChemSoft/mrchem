...
:red:`Sections`
 ...
 :Excited_states: Give details regarding the excited states calculation. 
  ...
  :red:`Keywords`
   ...
   :solver_type: What approximation to use to solve for the excited states. 
