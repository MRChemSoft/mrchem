...
HartreePotential::HartreePotential(std::shared_ptr<mrcpp::PoissonOperator> P, std::shared_ptr<OrbitalVector> Phi, const Nuclei &nucs, const double &rc)
...
void HartreePotential::setupGlobalDensity(double prec) {
    ...
    this->b_smeared = chemistry::compute_nuclear_density_smeared(this->apply_prec, this->nuclei, this->rc, period * 2.0);
