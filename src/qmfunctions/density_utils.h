...
void compute(double prec, Density &rho, OrbitalVector &Phi, OrbitalVector &X, OrbitalVector &Y, DensityType spin, bool tda = false);
void compute_local(double prec, Density &rho, OrbitalVector &Phi, DensityType spin);
void compute_local(double prec, Density &rho, OrbitalVector &Phi, OrbitalVector &X, OrbitalVector &Y, DensityType spin, bool tda = false);
