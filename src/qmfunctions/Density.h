...
/** @class Density
 *
 * @brief Complex-valued function with spin to represent both unperturbed and perturbed densities
 *
 ...
 * and a paramCopy() which returns an empty density with the same rank_id/spin/occ.
 *
