 ...
 *
 * Given a file name prefix (e.g. "dens_0"), this will produce separate
 * binary files for meta data ("dens_0.meta"), real ("dens_0_re.tree")
 * and imaginary ("dens_0_im.tree") parts.
 */
 ...
 * @param file: file name prefix
 *
 * Given a file name prefix (e.g. "dens_0"), this will read separate
 * binary files for meta data ("dens_0.meta"), real ("dens_0_re.tree")
 * and imaginary ("dens_0_im.tree") parts.
 */
